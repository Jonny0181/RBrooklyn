...
https://discord.gg/fmuvSX9""")
    ...
    async def stats(self, ctx):
        ...
        data.add_field(name="Channels", value="{} Voice Channels\n{} Text Channels\nTotal: {}".format(len([e.name for e in self.bot.get_all_channels() if e.type == discord.ChannelType.voice]), len([e.name for e in self.bot.get_all_channels() of e.type == discord.ChannelType.text]), len([e.name for e in self.bot.get_all_channels()])))
