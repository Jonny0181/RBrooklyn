...
https://discord.gg/fmuvSX9""")
    ...
    async def stats(self, ctx):
        ...
        data.add_field(name="Users", value="{} Online<:vpOnline:212789758110334977>\n{} Idle<:vpAway:212789859071426561>\n{} Dnd<:vpDnD:236744731088912384>\n{} Offline<:vpOffline:212790005943369728>\n**Total:** {}".format(online, idle, dnd, offline, len([e.name for e in bot.get_all_members()])))
        data.add_field(name="Channels", value="{} Voice Channels\n{} Text Channels\nTotal: {}".format(len([e.name for e in bot.get_all_channels() if e.type == discord.ChannelType.voice]), len([e.name for e in bot.get_all_channels() of e.type == discord.ChannelType.text]), len([e.name for e in bot.get_all_channels()])))
